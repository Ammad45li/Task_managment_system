        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post" id="add-form">
                    @csrf
                    <div class="mb-3">
                        <label for="add-description" class="form-label">Taske</label>
                        <input type="text" name="add-description" id="add-name" class="form-control" placeholder="Enter task description">
