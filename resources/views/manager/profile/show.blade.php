        ...
        <div class="col-md-7 col-xl-8">
            <div class="card">
                ...
                <div class="card-body h-100">
                    ...
                    <form action="{{ route('manager.details') }}" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                            <div class="col-md-6">
                ...
                <div class="card-body text-center">
                    ...
                    @else
                        <img src="https://ui-avatars.com/api/?name={{ $user->name }}"
                            alt="Placeholder picture" class="img-fluid rounded-circle mb-2" width="300" height="300" />
                    @endif

                    <div>
                        <form action="{{ route('manager.picture') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="mb-3">
